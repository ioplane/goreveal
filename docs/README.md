...
| Drive GoREveal from IDA | [IDA + idacli methodology](architecture/2026-07-22-goreveal-idacli-go-methodology.md) |
...
| [IDA + idacli methodology](architecture/2026-07-22-goreveal-idacli-go-methodology.md) | Working method for driving GoREveal alongside IDA |
