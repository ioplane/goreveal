...
- once a same-fixture bounded bridge chain is dense enough, prefer a second fixture or a small
  cross-check over further blind expansion
...
Sprint structure should follow vertical capability slices rather than horizontal architecture-only
milestones.
